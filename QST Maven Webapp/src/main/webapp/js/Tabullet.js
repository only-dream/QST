...
(function ($) {
    $.fn.tabullet = function (options) {
        var defaults = {
            ...
            editClass: 'el-button el-button--primary el-button--mini',
            deleteClass: 'el-button el-button--danger el-button--mini',
            saveClass: 'el-button btn btn-success fileinput-button el-button--success el-button--mini',
            deleteContent: '删除',
            editContent: '编辑',
            saveContent: '保存',
            action: function () {
        ...
        $(metadata).each(function (i, v) {
            ...
            if (v.readonly !== 'true') {
                $('<td/>').html('<span style="float:left;color:#057cfc; padding-right:50px;">添加</span><input type="text" name="' + v.map + '" class="' + options.textClass + '"/ style="float:left;">')
                    .appendTo(insertRow);
            }
            else {
